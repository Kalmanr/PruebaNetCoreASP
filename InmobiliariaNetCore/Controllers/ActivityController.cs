            ...
            using (Models.inmobiliariaContext db = new Models.inmobiliariaContext())
            {
                var GetActivityFiltred = (from n in db.CsActivities
                                          ...
                                          select new Models.Request.GetActivitiesAll { Id = n.Id,
                                              ...
                                              Status = n.Status,
                                              Condition = (n.Status == "Activa" && n.Schedule >= DateTime.Now) ? "Pendiente a Realizar" : (n.Status == "Activa" && n.Schedule <= DateTime.Now) ? "Atrasada" : (n.Status == "Finalizada" && n.Schedule <= DateTime.Now) ? "Finalizada" : "Cancelada",
